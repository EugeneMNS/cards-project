...
import {sendNewPasswordTC} from '../../bll/forgotReducer';
...
export const NewPassword = React.memo(() => {
    ...
    const isSend = useSelector<RootStateType, boolean>(
    ...
    const onSendPasswordChange = () => {
        if (token) dispatch(sendNewPasswordTC(valueInput, token) as any);
    };
